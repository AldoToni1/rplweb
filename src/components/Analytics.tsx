...
export function Analytics() {
  const { analytics, menuItems } = useMenu();
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-gray-50">
        ...
        <p className="text-sm text-gray-600">
          Analytics data tersimpan di localStorage browser Anda. Untuk production dengan
          real-time analytics dari semua customer, gunakan versi Supabase.
        </p>
      </Card>
    </div>
  );
