  ...
  return (
    <div
      ...
      className={`
        ...
        ${
          isItemDragging
            ? 'border-orange-500 shadow-xl scale-105 ring-1 ring-orange-200'
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-center">
        ...
        <h3 className="font-semibold text-gray-900 text-base truncate leading-tight">{item.name}</h3>
        ...
        <div className="flex items-center gap-2 mt-0.5">
          ...
          {/* Kategori: Font kecil */}
          <span className="text-gray-500 text-xs truncate bg-gray-100 px-2 py-0.5 rounded-full">{item.category}</span>
        </div>
      </div>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader className="pb-4">
          ...
          <CardDescription className="text-sm">Geser untuk mengubah posisi menu.</CardDescription>
        </CardHeader>
        <CardContent>
          <DndContext
            sensors={sensors}
