                  ...
                  {navItems.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        `}
                      >
                        <Icon className={`size-5 transition-transform duration-300 ${isActive ? 'scale-110' : 'group-hover:scale-110 group-hover:-rotate-3'}`} />
                        <span className={`text-sm tracking-wide ${isActive ? 'text-white' : 'text-gray-600 group-hover:text-gray-900'}`}>
                          {item.label}
                        </span>
                      </button>
                    );
